...
void CScene::BuildObjects(ID3D12Device *pd3dDevice, ID3D12GraphicsCommandList *pd3dCommandList)
{
	...
	pFbxDataManager->MeshFileRead("test_sphere");
	pFbxDataManager->SetTextureName("test_sphere_diff");
	m_pModelObject = new CModelObject(pd3dDevice, pd3dCommandList, m_pd3dGraphicsRootSignature, pFbxDataManager);
	m_pModelObject->SetPosition(15, 0, 0);
	m_pModelObject2 = new CModelObject(pd3dDevice, pd3dCommandList, m_pd3dGraphicsRootSignature, pFbxDataManager);
	...
	ac->Init(pd3dDevice, pd3dCommandList, pFbxDataManager);

	m_pModelTable = new CModelObject(pd3dDevice, pd3dCommandList, m_pd3dGraphicsRootSignature, pFbxDataManager);
	//m_pModelTable->Rotate(270, 0, 0);
	//m_pModelTable->SetPosition(0, 10, 0);

	pFbxDataManager->MeshFileRead("map_level_2");
	pFbxDataManager->SetTextureName("map_tex_0_diff");
	m_pTerrain = new TerrainObject(pd3dDevice, pd3dCommandList, m_pd3dGraphicsRootSignature, pFbxDataManager);
	m_pTerrain->Rotate(270, 0, 0);
...
ID3D12RootSignature *CScene::CreateGraphicsRootSignature(ID3D12Device *pd3dDevice)
{
	...
	pd3dRootParameters[6].ParameterType = D3D12_ROOT_PARAMETER_TYPE_SRV;
	pd3dRootParameters[6].Descriptor.ShaderRegister = 6; //t6
	...
	pd3dRootParameters[7].Descriptor.ShaderRegister = 7; //t7
	...
	pd3dRootParameters[8].Descriptor.ShaderRegister = 8;	//Bones
...
void CScene::AnimateObjects(float fTimeElapsed, ID3D12GraphicsCommandList *pd3dCommandList)
{
	...
	ac->Update(fTimeElapsed, pd3dCommandList);
}
...
void CScene::Render(ID3D12GraphicsCommandList *pd3dCommandList, CCamera *pCamera)
{
	...
	//m_pModelTerrain->UpdateTransform(NULL);
	//m_pModelTerrain->Render(pd3dCommandList, pCamera);
	...
	m_pModelObject2->UpdateTransform(NULL);
	m_pModelObject2->Render(pd3dCommandList, pCamera);
	m_pModelObject2->MoveStrafe(1);*/

	ac->BoneUpdate(pd3dCommandList);

	m_pModelTable->UpdateTransform(NULL);
	m_pModelTable->Render(pd3dCommandList, pCamera);
