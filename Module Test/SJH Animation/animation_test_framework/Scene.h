...
public:
    ...
    void AnimateObjects(float , ID3D12GraphicsCommandList *pd3dCommandList);
...
protected:
	...
	CModelObject* m_pModelObject2 = NULL;

	CModelObject* m_pModelTable = NULL;

	TerrainObject* m_pTerrain;

	AnimationController* ac = nullptr;
};
