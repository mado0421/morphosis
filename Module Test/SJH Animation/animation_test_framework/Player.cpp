...
CPlayer::CPlayer(ID3D12Device *pd3dDevice, ID3D12GraphicsCommandList *pd3dCommandList, ID3D12RootSignature *pd3dGraphicsRootSignature
	, FBXDataManager *pFbxManager, void *pContext) : CModelObject(pd3dDevice,pd3dCommandList,pd3dGraphicsRootSignature, pFbxManager)
{
...
{
	CModelObject::UpdateShaderVariables(pd3dCommandList);
...
CAirplanePlayer::CAirplanePlayer(ID3D12Device *pd3dDevice, ID3D12GraphicsCommandList *pd3dCommandList, ID3D12RootSignature *pd3dGraphicsRootSignature
	, FBXDataManager *pFbxManager, void *pContext) : CPlayer(pd3dDevice, pd3dCommandList, pd3dGraphicsRootSignature, pFbxManager, pContext )
{
