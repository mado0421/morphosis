...
protected:
	...
	ID3D12Resource *m_pd3dComputeResource = NULL;
...
public:
	...
	virtual ID3D12RootSignature *CreateComputeRootSignature(ID3D12Device *pd3dDevice) = 0;

protected:
	void CreateDescriptorHeap(int nObject);
	void SetComputeShaderResource();
