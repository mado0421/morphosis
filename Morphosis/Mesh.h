...
public:
	CVertex() {
		cout << "CVertex 생성 - " << sizeof(CVertex) << "\n";

	}
	CVertex(XMFLOAT3 position) :m_xmf3Position(position) { cout << "CVertex 생성 - " << sizeof(CVertex) << "\n"; }
};
...
public:
	CModelVertex() {
		cout << "CModelVertex 생성 - " << sizeof(CModelVertex) << "\n";
	}
...
public:
	CAnimatedVertex() {
		cout << "CAnimatedVertex 생성 - " << sizeof(CAnimatedVertex) << "\n";
	}
...
public:
	CUIVertex() {
		cout << "CUIVertex 생성 - " << sizeof(CUIVertex) << "\n";
	}
